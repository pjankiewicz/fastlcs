/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1ubuntu2) on Fri Oct 24 13:21:20 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__fastlcs___cython
#define __PYX_HAVE_API__fastlcs___cython
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'fastlcs._cython' */
#define __Pyx_MODULE_NAME "fastlcs._cython"
int __pyx_module_is_main_fastlcs___cython = 0;

/* Implementation of 'fastlcs._cython' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_7fastlcs_7_cython_lcs(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_s1, PyObject *__pyx_v_s2); /* proto */
...
static char __pyx_k_s1_2[] = "s1_";
static char __pyx_k_s2_2[] = "s2_";
...
static char __pyx_k_x_longest[] = "x_longest";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_RuntimeError[] = "RuntimeError";
static char __pyx_k_fastlcs__cython[] = "fastlcs._cython";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_home_pawel_Dropbox_webinterpret[] = "/home/pawel/Dropbox/webinterpret/lib/fastlcs/cython/fastlcs.pyx";
...
static PyObject *__pyx_n_s_fastlcs__cython;
static PyObject *__pyx_kp_s_home_pawel_Dropbox_webinterpret;
...
static PyObject *__pyx_n_s_s2_2;
static PyObject *__pyx_n_s_s2_len;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_x;
static PyObject *__pyx_n_s_x_longest;
...
/* Python wrapper */
static PyObject *__pyx_pw_7fastlcs_7_cython_1lcs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_7fastlcs_7_cython_1lcs = {__Pyx_NAMESTR("lcs"), (PyCFunction)__pyx_pw_7fastlcs_7_cython_1lcs, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_7fastlcs_7_cython_1lcs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_s2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("lcs", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lcs") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __Pyx_RaiseArgtupleInvalid("lcs", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("fastlcs._cython.lcs", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7fastlcs_7_cython_lcs(__pyx_self, __pyx_v_s1, __pyx_v_s2);
...
static PyObject *__pyx_pf_7fastlcs_7_cython_lcs(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_s1, PyObject *__pyx_v_s2) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_longest;
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_AsString(__pyx_v_s1); if (unlikely((!__pyx_t_1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_s1_ = __pyx_t_1;

  /* "cython/fastlcs.pyx":12
 *     cdef int m[200][200]
 *     cdef char* s1_ = s1
 *     cdef char* s2_ = s2             # <<<<<<<<<<<<<<
 * 
 *     s1_len = len(s1_)
 */
  __pyx_t_1 = __Pyx_PyObject_AsString(__pyx_v_s2); if (unlikely((!__pyx_t_1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_s2_ = __pyx_t_1;

  /* "cython/fastlcs.pyx":14
 *     cdef char* s2_ = s2
 * 
 *     s1_len = len(s1_)             # <<<<<<<<<<<<<<
 *     s2_len = len(s2_)
 * 
 */
  __pyx_t_2 = strlen(__pyx_v_s1_); 
  __pyx_v_s1_len = __pyx_t_2;

  /* "cython/fastlcs.pyx":15
 * 
 *     s1_len = len(s1_)
 *     s2_len = len(s2_)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = strlen(__pyx_v_s2_); 
  __pyx_v_s2_len = __pyx_t_2;

  /* "cython/fastlcs.pyx":17
 *     s2_len = len(s2_)
 * 
 *     for x in range(1, 1 + s1_len):             # <<<<<<<<<<<<<<
 ...
 *             if s1_[x - 1] == s2_[y - 1]:
 */
  __pyx_t_3 = (1 + __pyx_v_s1_len);
  for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_x = __pyx_t_4;

    /* "cython/fastlcs.pyx":18
 * 
 *     for x in range(1, 1 + s1_len):
 *         for y in range(1, 1 + s2_len):             # <<<<<<<<<<<<<<
 *             if s1_[x - 1] == s2_[y - 1]:
 *                 m[x][y] = m[x - 1][y - 1] + 1
 */
    __pyx_t_5 = (1 + __pyx_v_s2_len);
    for (__pyx_t_6 = 1; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_y = __pyx_t_6;

      /* "cython/fastlcs.pyx":19
 *     for x in range(1, 1 + s1_len):
 *         for y in range(1, 1 + s2_len):
 *             if s1_[x - 1] == s2_[y - 1]:             # <<<<<<<<<<<<<<
 *                 m[x][y] = m[x - 1][y - 1] + 1
 *                 if m[x][y] > longest:
 */
      __pyx_t_7 = (((__pyx_v_s1_[(__pyx_v_x - 1)]) == (__pyx_v_s2_[(__pyx_v_y - 1)])) != 0);
      if (__pyx_t_7) {

        /* "cython/fastlcs.pyx":20
 *         for y in range(1, 1 + s2_len):
 *             if s1_[x - 1] == s2_[y - 1]:
 *                 m[x][y] = m[x - 1][y - 1] + 1             # <<<<<<<<<<<<<<
 *                 if m[x][y] > longest:
 *                     longest = m[x][y]
 */
        ((__pyx_v_m[__pyx_v_x])[__pyx_v_y]) = (((__pyx_v_m[(__pyx_v_x - 1)])[(__pyx_v_y - 1)]) + 1);

        /* "cython/fastlcs.pyx":21
 *             if s1_[x - 1] == s2_[y - 1]:
 *                 m[x][y] = m[x - 1][y - 1] + 1
 *                 if m[x][y] > longest:             # <<<<<<<<<<<<<<
 *                     longest = m[x][y]
 *                     x_longest = x
 */
        __pyx_t_7 = ((((__pyx_v_m[__pyx_v_x])[__pyx_v_y]) > __pyx_v_longest) != 0);
        if (__pyx_t_7) {

          /* "cython/fastlcs.pyx":22
 *                 m[x][y] = m[x - 1][y - 1] + 1
 *                 if m[x][y] > longest:
 *                     longest = m[x][y]             # <<<<<<<<<<<<<<
 *                     x_longest = x
 *             else:
 */
          __pyx_v_longest = ((__pyx_v_m[__pyx_v_x])[__pyx_v_y]);

          /* "cython/fastlcs.pyx":23
 *                 if m[x][y] > longest:
 *                     longest = m[x][y]
 *                     x_longest = x             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "cython/fastlcs.pyx":25
 *                     x_longest = x
 *             else:
 *                 m[x][y] = 0             # <<<<<<<<<<<<<<
 *     return s1[x_longest - longest: x_longest]
 */
        ((__pyx_v_m[__pyx_v_x])[__pyx_v_y]) = 0;
      }
      __pyx_L7:;
    }
  }

  /* "cython/fastlcs.pyx":26
 *             else:
 *                 m[x][y] = 0
 *     return s1[x_longest - longest: x_longest]             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_8 = __Pyx_PyObject_GetSlice(__pyx_v_s1, (__pyx_v_x_longest - __pyx_v_longest), __pyx_v_x_longest, NULL, NULL, NULL, 1, 1, 1); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fastlcs__cython, __pyx_k_fastlcs__cython, sizeof(__pyx_k_fastlcs__cython), 0, 0, 1, 1},
  {&__pyx_kp_s_home_pawel_Dropbox_webinterpret, __pyx_k_home_pawel_Dropbox_webinterpret, sizeof(__pyx_k_home_pawel_Dropbox_webinterpret), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_s2_2, __pyx_k_s2_2, sizeof(__pyx_k_s2_2), 0, 0, 1, 1},
  {&__pyx_n_s_s2_len, __pyx_k_s2_len, sizeof(__pyx_k_s2_len), 0, 0, 1, 1},
  {&__pyx_n_s_test, __pyx_k_test, sizeof(__pyx_k_test), 0, 0, 1, 1},
  {&__pyx_kp_u_unknown_dtype_code_in_numpy_pxd, __pyx_k_unknown_dtype_code_in_numpy_pxd, sizeof(__pyx_k_unknown_dtype_code_in_numpy_pxd), 0, 1, 0, 0},
  {&__pyx_n_s_x, __pyx_k_x, sizeof(__pyx_k_x), 0, 0, 1, 1},
  {&__pyx_n_s_x_longest, __pyx_k_x_longest, sizeof(__pyx_k_x_longest), 0, 0, 1, 1},
 ...
 *     cdef int m[200][200]
 */
  __pyx_tuple__7 = PyTuple_Pack(11, __pyx_n_s_s1, __pyx_n_s_s2, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_longest, __pyx_n_s_x_longest, __pyx_n_s_s1_len, __pyx_n_s_s2_len, __pyx_n_s_m, __pyx_n_s_s1_2, __pyx_n_s_s2_2); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_pawel_Dropbox_webinterpret, __pyx_n_s_lcs, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_cython"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fastlcs___cython) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "fastlcs._cython")) {
      if (unlikely(PyDict_SetItemString(modules, "fastlcs._cython", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int m[200][200]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7fastlcs_7_cython_1lcs, NULL, __pyx_n_s_fastlcs__cython); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_lcs, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init fastlcs._cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fastlcs._cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
